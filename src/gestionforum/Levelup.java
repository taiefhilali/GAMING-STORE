...
//        
        ...
        Post post2 = new Post("Sujet2", " gaming", date, 3, 4);
         Post post4 = new Post("newss"," viDEOS",date,3,4);       
        Post post5 = new Post(40,"hahaha", "videogame",date,2,4);
        //Comment
      //  Comment comment1 = new Comment("firstcomment", "comm", 12,c,post5);
       //Comment comment2 = new Comment("secondcomment", "commtwo", 10,user1,post4);
        
        // AJOUT post
        //   System.out.println("POST added!");
           System.out.println(spost.ajouterPost(post4 ));
      ...
      //  Comment comment3= new Comment(24, "THIRDcomment", "HAHAAHA", 13,c,post4);
        ///***********jointure*******
          //System.out.println(scomment.ajouterComment(comment3));
...
//System.out.println("TRIE SELON <DATE>  DES POSTS :"+spost.sortByDate());
 ...
 // ***** count*********//
 //System.out.println(scomment.Commentsum());
//        
//        //  *******************************************  COMMANDE ET PANIER *******************************************  //
