...
public class Levelup {
    ...
    public static void main(String[] args) {
        ...
        // Client   
      User user1 = new User("Amalouira@gmail.com", "test", "client", "beldi", "mariem", adr, "26386558",date);
       Client c = new Client("femme",4);
...
//        System.out.println(sa.supprimerPersonne(au));
      ...
      // System.out.println(sfacture.supprimerFacture(f1));
        ...
        Produit p = new Produit(38,"HyperX Cloud II", "0x001", 1, 0, " Un casque pour les Gamers pro.", " En Stock ",user1 ); //en TND
       ...
       Produit p2 = new Produit(40, "Chaise", ")Xààç", 3, 660, "chaise pour les gamer ", " En stock",user1);
        //test modification
        //Produit p2 = new Produit("Chaise v1 modifiée", "0X000", 2, 60, "Chaise pour les Gamers", " En stock", 4);    // produit avec id
        //Produit p3 = new Produit(7, " Bureaux TX510", "0X0070", 3, 250, " Un bureau pour les gamers ", "  Out of stock ", 4);
        // Ajout des produits 
      ...
      //   System.out.println(spost.supprimerPost(post3));
        ...
        //  *******************************************  COMMANDE ET PANIER *******************************************  //
        Client cu8 = new Client("homme",7);

        Commande commande1 = new Commande(8,cu8, 15, date);
        Panier panier1 = new Panier(5, cu8);
        Panier_elem e = new Panier_elem(1, panier1, p);
        Commande_elem e1 = new Commande_elem(2, p, commande1,1);

        //System.err.println(spanier2.afficherPanier(3));
        //System.err.println(spanier3.AfficherCommande(8));
        //System.err.println(scommande.AfficherCommande());
        //System.err.println(scommande.AfficherCommandeId(3));
        //AJOUT
