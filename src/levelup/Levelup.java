...
//        System.out.println(sa.supprimerPersonne(au));
        ...
        Post post1 = new Post("sujet11", "JEUX VIDEOS", date, c);
        Post post2 = new Post("Sujet2", " fournisseur", date, c);
        Post post4 = new Post("newss", " viDEOS", date, c);
        Post post5 = new Post(112, "sujet5", "videogame", date, c);
        //Comment
        //Comment comment1 = new Comment("hhhhhhhhhhhh", "comm", 12, post5);
       // Comment comment2 = new Comment("secondcomment", "commtwo", 10, c, post5);

        // ****************AJOUT post********************************//
       Servicepost spost=new Servicepost();
       spost.chercherPost(spost.sh(),"Sujet2");
...
//        System.out.println(spost.afficherPost());
      ...
      //  System.out.println(scomment.ajouterComment(comment1));
        ...
        //********************** MODIFIERPOST**************************//
        Post post3 = new Post(75, "sujet2", "great news", date, c);
...
//        ///****************BEST POST**********//////
//      
 //System.out.println("LES Meilleures POSTS :" + scomment.bestpost(21));
